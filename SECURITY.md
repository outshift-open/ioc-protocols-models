...
The `ioc-protocols-models` maintainers take all security issues in the project
seriously. Thank you for improving the security of `ioc-protocols-models`. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

`ioc-protocols-models` leverages GitHub's private vulnerability reporting.
