...
create_go_module_tag() {
    ...
    local module_path="github.com/cisco-eti/ioc-cfn-protocols-models/SSTP/language_bindings/golang"
...
Go Module Management:
  ...
  go list -m github.com/cisco-eti/ioc-cfn-protocols-models/SSTP/language_bindings/golang@v1.0.0
