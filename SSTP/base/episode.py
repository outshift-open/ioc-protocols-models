...
"""
SSTP/base/episode.py — Application-facing L9 Episode API.
...
from SSTP.base.grounding import receive_peer_turn as _receive_peer_turn

_LOGGER = logging.getLogger("sstp.base")
...
class L9:
    ...
    def receive_peer_turn(
        ...
        *,
        ...
        Delegates to :func:`SSTP.base.grounding.receive_peer_turn`.
...
# Re-export so importers can do: from SSTP.base.episode import DebateRoundContext
