...
try:
    from SSTP.subprotocol.cip.language_bindings.python.assertion import AgentIdentity, UtteranceAssertion, AssertionVerificationError, build_assertion, verify_assertion
except ImportError:
    AgentIdentity = None               # type: ignore
    UtteranceAssertion = None          # type: ignore
    AssertionVerificationError = None  # type: ignore
    build_assertion = None             # type: ignore
    verify_assertion = None            # type: ignore
