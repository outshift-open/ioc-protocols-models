...
from SSTP.subprotocol.siep.language_bindings.python.tomcore.llm import LLMClient
from SSTP.subprotocol.siep.language_bindings.python.epistemic.stores import AgentEpistemicStore
...
class TheoryOfMindEngineBase:
    """Minimal base class for TheoryOfMindEngine (stub — no CIP dependency)."""
    pass
...
class AgentTOM:
    ...
    def assess_utterance(self, utterance: str = "", task_goal: str = "", speaker: str = "",
        ...
        try:
            from SSTP.subprotocol.cip.language_bindings.python.grounding import contingency_check, diagnose_repair_reason
            _has_grounding = True
        except ImportError:
        ...
        if has_concepts and _has_grounding:
