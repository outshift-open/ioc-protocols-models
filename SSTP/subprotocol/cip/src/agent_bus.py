...
from SSTP.subprotocol.siep.src.epistemic import SpeechAct, EpistemicState, BeliefStatus, make_epistemic_block
...
class AgentBus:
    ...
    def emit_taskwork_result(
        ...
        *,
        ...
        """
        from SSTP.subprotocol.siep.src.epistemic.vocabulary import make_epistemic_block, BeliefStatus
    ...
    def emit_knowledge_rule(
        ...
        *,
        ...
        """
        from SSTP.subprotocol.siep.src.epistemic.vocabulary import make_epistemic_block, BeliefStatus
        from SSTP.subprotocol.cip.src.l9 import build_l9_header as _build
        _utterance = (
