...
class CIPPayload:
    ...
    initial_prior: grounding=CIPGroundingBlock() (all null)
    peer_turn:     grounding=CIPGroundingBlock(contingency_verified=..., contingency_score=...)
    repair_*:      grounding=CIPGroundingBlock(repair_reason=...)
    """
    ...
    @classmethod
    def from_dict(cls, d: dict) -> "CIPPayload":
        u = d.get("utterance", {})
        g = d.get("grounding", {})
        b = d.get("belief", {})
        return cls(
...
IEUtteranceBlock = CIPUtteranceBlock
IEGroundingBlock = CIPGroundingBlock
IEBeliefBlock = CIPBeliefBlock
IEPayload = CIPPayload
